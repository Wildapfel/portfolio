...
cp:
	...
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/pr_$(SVM_LINEAR).png ./report/images/$(EXP04)/pr_$(SVM_LINEAR)_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR)_d.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR)_d_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR)_f1.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR)_g_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR)_g.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR)_j_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR)_j.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR)_f1_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_GSE16455_test/feat_sel_1/prob_$(SVM_LINEAR).png ./report/images/$(EXP04)/prob_$(SVM_LINEAR)_f1_test2.png

	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/roc_$(SVM_LINEAR_WEIGHTED).png ./report/images/$(EXP04)/roc_$(SVM_LINEAR_WEIGHTED)_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/pr_$(SVM_LINEAR_WEIGHTED).png ./report/images/$(EXP04)/pr_$(SVM_LINEAR_WEIGHTED)_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR_WEIGHTED)_d.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR_WEIGHTED)_d_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR_WEIGHTED)_f1.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR_WEIGHTED)_g_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR_WEIGHTED)_g.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR_WEIGHTED)_j_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_train/feat_sel_1/cm_$(SVM_LINEAR_WEIGHTED)_j.png ./report/images/$(EXP04)/cm_$(SVM_LINEAR_WEIGHTED)_f1_train.png
	cp ./__experiments/$(EXP04)/classifiers/cll_assoc_probes/eval_GSE16455_test/feat_sel_1/prob_$(SVM_LINEAR_WEIGHTED).png ./report/images/$(EXP04)/prob_$(SVM_LINEAR_WEIGHTED)_f1_test2.png
